...
class RegisterVendeur (View):
    ...
    def post(self, request):
        ...
        if not error_message:
            print (name, commercial_name, address, phone_siege, email, num_fiscal, num_stat, num_cin, nom_pers, phone_pers, email_pers, liste_pays, liste_fournissseur, article_phare, secteur_activite, password)
